...
export const selectLibraryEntryMemoized = createSelector(
  [(s: RootState, libraryId: string) => s.libraryUsers.byLibrary[libraryId], (_, libraryId: string) => libraryId],
  (entry) => entry ?? { uids: [], users: {} }
)
